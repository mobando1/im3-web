// Defaults del landing público (im3systems.com).
// Fuente de verdad del COPY base del sitio. El CMS (cms_pages.publishedContent)
// se superpone sobre estos defaults vía deepMerge; un campo ausente cae aquí.
//
// Vive en shared/ (no en client/) porque lo necesitan DOS lados:
//   - cliente: I18nProvider hace deepMerge(translations[lang], publishedContent)
//   - servidor: el bot-prerender de server/static.ts renderiza desde el contenido
//     publicado mergeado sobre estos defaults.
// Es data pura (sin imports de runtime ni JSX), por eso es .ts y cross-cutting.
