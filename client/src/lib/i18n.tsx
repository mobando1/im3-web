  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "¿Cuánto toma una implementación típica?", answer: "Un MVP funcional con inteligencia artificial integrada suele estar listo en 4 a 8 semanas. Empezamos con lo que más impacta tu operación y vamos iterando con entregas semanales." },
    ...
    newsletter: {
      popupTitle: "Lo que está pasando en tech esta semana",
      popupDescription: "IA, automatización y herramientas que puedes usar ya. 3 pasos accionables cada semana. Sin humo.",
      sectionTitle: "Tech que puedes usar esta semana",
      sectionDescription: "Cada semana te mandamos lo más relevante en IA y automatización — con 3 cosas concretas que puedes aplicar. 2 min de lectura.",
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "How long does a typical implementation take?", answer: "A functional MVP with AI integrated is usually ready in 4 to 8 weeks. We start with what impacts your operation most and iterate with weekly deliveries." },
    ...
    newsletter: {
      popupTitle: "What's happening in tech this week",
      popupDescription: "AI, automation, and tools you can use right now. 3 actionable steps every week. No fluff.",
      sectionTitle: "Tech you can use this week",
      sectionDescription: "Every week we send you the most relevant AI and automation updates — with 3 concrete things you can apply. 2-min read.",
