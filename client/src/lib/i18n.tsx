  ...
  es: {
    ...
    testimonials: {
      ...
      reviews: [
        ...
        { quote: "Nos construyeron la página web y un chatbot de ventas y atención al cliente en WhatsApp. Los resultados fueron asombrosos — cerramos más ventas y nuestros clientes reciben respuesta inmediata, 24/7.", author: "Nicolás Hernández", role: "Fundador y CEO · Xtremcol", featured: true },
  ...
  en: {
    ...
    testimonials: {
      ...
      reviews: [
        ...
        { quote: "They built our website and a WhatsApp sales and customer service chatbot. The results were amazing — we close more sales and our clients get instant responses, 24/7.", author: "Nicolás Hernández", role: "Founder & CEO · Xtremcol", featured: true },
