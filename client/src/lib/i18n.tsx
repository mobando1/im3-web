...
const translations = {
  es: {
    ...
    priorities: {
      ...
      structureDesc: "Diseño del sistema antes del código.",
      maintainable: "Mantenible",
      maintainableDesc: "Documentación y handoff para operar.",
    },
    logoStrip: {
    ...
    widget: {
      ...
      dashboard: "Dashboard",
      logicBuilder: "Constructor de lógica",
      database: "Base de datos",
      todayMetrics: "Métricas de hoy",
      processedOrders: "Pedidos procesados",
      taskCompletion: "Tareas completadas",
      systemUptime: "Uptime del sistema",
      ordersPerHour: "Pedidos / Hora",
      automationFlow: "Flujo de automatización",
      triggerNewOrder: "Trigger: Nuevo pedido",
      ...
      toasts: {
        ...
        automationSuccess: "Automatización ejecutada",
      },
    },
  },
  en: {
    ...
    priorities: {
      ...
      subtitle: "Order → clarity → execution. Technology serving operations, not the other way around.",
      clearExecution: "Clear execution",
      clearExecutionDesc: "Defined scope, deliverables, and success criteria.",
      structure: "Structure first",
      structureDesc: "System design before code.",
      maintainable: "Built to last",
      maintainableDesc: "Documentation and handoff for long-term operation.",
    },
    logoStrip: {
    ...
    widget: {
      ...
      triggerNewOrder: "Trigger: New Order",
      ...
      toasts: {
        ...
        automationSuccess: "Automation executed",
      },
    },
  },
};
