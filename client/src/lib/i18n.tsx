...
const translations = {
  es: {
    ...
    newsletter: {
      popupTitle: "Tendencias tech para tu empresa",
      popupDescription: "Cada semana, 2 minutos de IA, automatización y pasos concretos que puedes aplicar en tu operación.",
      sectionTitle: "Recibe tendencias tech cada semana",
      sectionDescription: "IA, automatización y pasos accionables para tu empresa. 2 minutos de lectura, sin spam.",
      placeholder: "tu@email.com",
      subscribe: "Suscribirme",
      success: "Revisa tu correo para el email de bienvenida.",
  ...
  en: {
    ...
    newsletter: {
      popupTitle: "Tech trends for your business",
      popupDescription: "Every week, 2 minutes of AI, automation, and actionable steps you can apply to your operations.",
      sectionTitle: "Get weekly tech trends",
      sectionDescription: "AI, automation, and actionable steps for your business. 2-minute read, no spam.",
      placeholder: "you@email.com",
      subscribe: "Subscribe",
      success: "Check your inbox for the welcome email.",
