...
export default function Booking() {
  ...
  return (
    <div className="min-h-screen bg-[#0F2438] md:bg-background flex flex-col md:flex-row font-sans text-foreground selection:bg-primary/20 overflow-x-hidden">

      {/* MOBILE HEADER - Visible only on mobile */}
      <div className="md:hidden bg-[#0F2438] p-6 pb-2 border-b border-white/5 relative overflow-hidden text-white">
         <div className="relative z-10">
            <div className="mb-6 inline-block bg-white p-2.5 rounded-lg shadow-sm">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-white mb-2 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2FA4A9] to-blue-400">y Tecnología</span>
            </h1>
            <div className="flex items-center gap-2 text-slate-300 text-xs font-medium">
               <Clock className="w-3 h-3 text-[#2FA4A9]" />
      ...
      <div className="w-full md:w-5/12 lg:w-4/12 border-r border-border/10 bg-[#0F2438] z-10 relative overflow-hidden text-white shadow-2xl order-2 md:order-1 flex flex-col flex-1 md:h-screen md:sticky md:top-0">

        {/* Animated Background Layers (Only visible on desktop to save mobile performance/distraction) */}
        <div className="absolute inset-0 z-0 hidden md:block">
          <div className="absolute inset-0 bg-gradient-to-b from-[#0F2438] via-[#0F2438] to-[#0A1A2A]" />
          ...
          />
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2FA4A9] rounded-full blur-[120px] opacity-[0.08] translate-x-1/2 -translate-y-1/2 animate-pulse-glow" />
        </div>
          ...
          <div className="p-6 md:p-12 lg:p-16 max-w-xl mx-auto md:mx-0 md:ml-auto min-h-full flex flex-col justify-between relative z-10">
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="hidden md:block space-y-12">
                <div className="animate-in fade-in slide-in-from-top-4 duration-700 inline-block bg-white p-3.5 rounded-xl shadow-lg cursor-pointer hover:scale-[1.02] transition-transform">
              ...
              <header className="animate-in fade-in slide-in-from-left-4 duration-700 delay-100">
                ...
                <div className="flex items-center gap-3 text-slate-300 text-sm font-medium border-l-2 border-[#2FA4A9] pl-4">
            ...
            <div className="space-y-6 pt-8 md:pt-0 bg-[#0F2438] md:bg-transparent -mx-6 px-6 md:mx-0 md:px-0">
              ...
              <div className="grid gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                <div className="group p-5 rounded-xl bg-white/5 border border-white/5 hover:border-[#2FA4A9]/30 hover:bg-white/10 transition-all duration-300 cursor-default">
                  <h3 className="text-white font-medium mb-2 flex items-center gap-2 group-hover:text-[#2FA4A9] transition-colors">
                ...
                <ul className="space-y-3">
                   {["Casos de uso reales de IA en tu sector", "Análisis de viabilidad técnica", "Roadmap de implementación sugerido"].map((item, i) => (
                     <li key={i} className="flex items-center gap-3 text-sm text-slate-300">
                       <div className="w-5 h-5 rounded-full bg-[#2FA4A9]/20 flex items-center justify-center shrink-0">
                          <CheckCircle2 className="w-3 h-3 text-[#2FA4A9]" />
                       </div>
                       <span>{item}</span>
                     </li>
                   ))}
            ...
            <div className="mt-12 pt-8 border-t border-white/5 animate-in fade-in duration-1000 delay-500 pb-8 md:pb-0">
              <div className="flex items-start gap-3 opacity-70 hover:opacity-100 transition-opacity">
                 <ShieldCheck className="w-5 h-5 text-[#2FA4A9] shrink-0 mt-0.5" />
      ...
      <div className="w-full md:w-7/12 lg:w-8/12 bg-[#F8FAFC] min-h-[500px] relative order-1 md:order-2">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-0 md:p-8 lg:p-12">
          ...
          <div className="w-full max-w-[700px] animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
             ...
             <div className="bg-white/80 backdrop-blur-sm shadow-none md:shadow-2xl md:shadow-slate-200/50 rounded-none md:rounded-2xl overflow-hidden md:border border-white/60 p-0 md:p-2 md:ring-1 ring-slate-900/5 transform transition-transform duration-500 md:hover:scale-[1.005]">
               <iframe
             ...
             <div className="mt-4 mb-4 md:mt-8 flex justify-center items-center gap-3 opacity-60">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-6 h-6 rounded-full bg-[#0F2438] border-2 border-white flex items-center justify-center text-[8px] text-white font-bold">IM3</div>
                </div>
