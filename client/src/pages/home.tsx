      ...
      <div className="max-w-7xl mx-auto bg-[hsl(var(--hero-bg))] rounded-2xl sm:rounded-[32px] overflow-hidden text-white relative shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 p-5 sm:p-8 md:p-16 relative z-10 items-center">
          <div className="space-y-8">
            ...
            <Reveal delay={100}>
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-[1.3] tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-400 pb-1">
                {t.hero.headline}
              </h1>
            </Reveal>
      ...
      <Reveal>
        <div className="max-w-2xl mx-auto rounded-2xl p-6 sm:p-8 text-center">
          ...
          {!done ? (
            ...
            <p className="text-sm text-[hsl(var(--teal))] font-medium flex items-center justify-center gap-2">
